...
Network.prototype.render = function () {
  ...
  if (providerName === 'cpx_mainnet') {
    hoverText = context.t('cpx_mainnet')
    iconName = 'cpx-network'
  } else if (providerName === 'cpx_testnet') {
    hoverText = context.t('cpx_testnet')
    iconName = 'cpx-test-network'
  ...
  return (
    h('div.network-component.pointer', {
      className: classnames({
        ...
        'cpx-network': providerName === 'cpx_mainnet',
        'cpx-test-network': providerName === 'cpx_testnet',
        ...
        switch (iconName) {
          case 'cpx-network':
            return h('.network-indicator', [
              ...
              h('.network-name', context.t('cpx_mainnet')),
              h('.network-indicator__down-arrow'),
            ])
          case 'cpx-test-network':
            return h('.network-indicator', [
              h(NetworkDropdownIcon, {
              ...
              h('.network-name', context.t('cpx_testnet')),
              h('.network-indicator__down-arrow'),
            ])
