  ...
  return h(Dropdown, {
    ...
    h(
      DropdownMenuItem,
      {
        ...
        onClick: () => this.handleClick('cpx_mainnet'),
        style: dropdownMenuItemStyle,
      },
      [
        providerType === 'cpx_mainnet' ? h('i.fa.fa-check') : h('.network-check__transparent', '✓'),
        h(NetworkDropdownIcon, {
          backgroundColor: '#7057ff', // $cornflower-blue
          isSelected: providerType === 'cpx_mainnet',
        }),
        h('span.network-name-item', {
          style: {
            color: providerType === 'cpx_mainnet' ? '#ffffff' : '#9b9b9b',
          },
        }, this.context.t('cpx_mainnet')),
      ]
    ),
    ...
    h(
      DropdownMenuItem,
      {
        key: 'cpx_testnet',
        closeMenu: () => this.props.hideNetworkDropdown(),
        onClick: () => this.handleClick('cpx_testnet'),
        style: { ...dropdownMenuItemStyle, borderColor: '#038789' },
      },
      [
        providerType === 'cpx_testnet' ? h('i.fa.fa-check') : h('.network-check__transparent', '✓'),
        h(NetworkDropdownIcon, {
          backgroundColor: '#ff4a8d', // $wild-strawberry
          isSelected: providerType === 'cpx_testnet',
        }),
        h('span.network-name-item', {
          style: {
            color: providerType === 'cpx_testnet' ? '#ffffff' : '#9b9b9b',
          },
        }, this.context.t('cpx_testnet')),
      ]
    ),
...
NetworkDropdown.prototype.getNetworkName = function () {
  ...
  // add cpx main,testnet 20190717 dadfkim@hanmail.net
  if (providerName === 'cpx_mainnet') {
    name = this.context.t('cpx_mainnet')
  } else if (providerName === 'cpx_testnet') {
    name = this.context.t('cpx_testnet')
