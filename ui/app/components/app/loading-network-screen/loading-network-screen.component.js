...
export default class LoadingNetworkScreen extends PureComponent {
  ...
  getConnectingLabel = function (loadingMessage) {
    ...
    if (providerName === 'cpx_mainnet') {
      name = this.context.t('connectingToCpxMainnet') //connectingToCpxMainnet message 추가 (언어팩임)
    } else if (providerName === 'cpx_testnet') {
      name = this.context.t('connectingToCpxTestnet') //connectingToCpxTestnet message 추가 (언어팩임)
